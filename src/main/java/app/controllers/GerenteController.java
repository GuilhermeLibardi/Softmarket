...
public class GerenteController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Timeline oi = new Timeline(new KeyFrame(Duration.seconds(5), event -> task1.run()));
        oi.setCycleCount(Timeline.INDEFINITE);
        oi.play();
    }
    ...
    void addProduto() {
        try {
            changeScreen("/fxml/telaAdicionarProduto.fxml");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    void editProduto() {
        try {
            changeScreen("/fxml/telaEditarProduto.fxml");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    void editProduto(String cod) {
        try {
            changeScreen("/fxml/telaEditarProduto.fxml", cod);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    void removeProduto() {
        try {
            changeScreen("/fxml/telaRemoverProduto.fxml");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    void removeProduto(String cod) {
        try {
            changeScreen("/fxml/telaRemoverProduto.fxml", cod);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    void addReceita() {
        try {
            changeScreen("/fxml/telaAdicionarReceita.fxml");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    void editReceita() {
        try {
            changeScreen("/fxml/telaEditarReceita.fxml");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    void removeReceita() {
        try {
            changeScreen("/fxml/telaRemoverReceita.fxml");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    void addIngrediente() {
        try {
            changeScreen("/fxml/telaAdicionarIngrediente.fxml");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    void editIngrediente() {
        try {
            changeScreen("/fxml/telaEditarIngrediente.fxml");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    void editIngrediente(String cod) {
        try {
            changeScreen("/fxml/telaEditarIngrediente.fxml", cod);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
