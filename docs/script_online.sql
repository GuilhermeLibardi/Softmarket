...
CREATE TABLE IF NOT EXISTS `receitas_contem_ingredientes` (
...
CREATE TABLE IF NOT EXISTS `vendas_contem_receitas` (
...
CREATE TABLE IF NOT EXISTS `vendas_contem_produtos` (
  `vendas_cod`         INT         NOT NULL,
